...
#recall map
    map_dir = LaunchConfiguration(
        ...
        default=os.path.join(
            get_package_share_directory("carter_navigation"), "maps", "warehouse_shelves.yaml"
        ),
    )
#recall params param=parameters
...
#point cloud data to laser scan  good to use for navigation and future use
            Node(
